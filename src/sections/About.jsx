      ...
      <div className="flex flex-col gap-4 mt-12">
        ...
        <div className="flex grid-default-color grid-1 relative">
          <div className="z-10 w-full justify-center">
            ...
            <button 
              className="z-10 px-4 py-2 mt-10 cursor-pointer hover:underline h-15 text-white rounded-md bg-primary"
          ...
          <figure className="absolute left-[75%] top-[10%] md:scale-125">
            <Globe />
          </figure>
        </div>
