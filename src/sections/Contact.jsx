  ...
  return (
    <section className="relative flex items-center c-space section-spacing">
      ...
      <div className="flex flex-col items-center justify-center max-w-md p-5 mx-auto border border-white/10 rounded-2xl bg-primary">
        ...
        <a href="mailto:imabhishek40@gmail.com" target="_blank" rel="noopener noreferrer" className="group relative w-28 h-28">
          <div className="relative w-full h-full transition-transform duration-300 group-hover:-rotate-35 group-hover:skew-y-20">
            ...
            <span className="absolute inset-0 flex items-center justify-center text-5xl text-red-500">
              <i className="fas fa-envelope"></i>
            </span>
          </div>
        </a>
        <a href="https://api.whatsapp.com/send?phone=918009615096" target="_blank" rel="noopener noreferrer" className="group relative w-28 h-28">
          <div className="relative w-full h-full transition-transform duration-300 group-hover:-rotate-35 group-hover:skew-y-20">
            ...
            <span className="absolute inset-0 flex items-center justify-center text-5xl text-green-500">
              <i className="fab fa-whatsapp"></i>
            </span>
          </div>
        </a>
        <a href="https://www.instagram.com/imabhishek40/" target="_blank" rel="noopener noreferrer" className="group relative w-28 h-28">
          <div className="relative w-full h-full transition-transform duration-300 group-hover:-rotate-35 group-hover:skew-y-20">
            ...
            <span className="absolute inset-0 flex items-center justify-center text-5xl text-pink-500">
              <i className="fab fa-instagram"></i>
            </span>
          </div>
        </a>
        <a href="https://t.me/aknocodes" target="_blank" rel="noopener noreferrer" className="group relative w-28 h-28">
          <div className="relative w-full h-full transition-transform duration-300 group-hover:-rotate-35 group-hover:skew-y-20">
            ...
            <span className="absolute inset-0 flex items-center justify-center text-5xl text-sky-500">
              <i className="fab fa-telegram"></i>
            </span>
          </div>
        </a>
        <a href="https://www.linkedin.com/in/abhishek-kumar-nigam/" target="_blank" rel="noopener noreferrer" className="group relative w-28 h-28">
          <div className="relative w-full h-full transition-transform duration-300 group-hover:-rotate-35 group-hover:skew-y-20">
            ...
            <span className="absolute inset-0 flex items-center justify-center text-5xl text-blue-600">
              <i className="fab fa-linkedin-in"></i>
            </span>
          </div>
        </a>
        <a href="https://github.com/akncodes" target="_blank" rel="noopener noreferrer" className="group relative w-28 h-28">
          <div className="relative w-full h-full transition-transform duration-300 group-hover:-rotate-35 group-hover:skew-y-20">
