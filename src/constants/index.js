export const myProjects = [
  {
    id: 1,
    title: "ABHYUDAYA '25 – MMMUT Cultural Fest Website",
    description:
    ...
    subDescription: [
      "Built a dynamic, engaging, and responsive platform end-to-end using React.js and Express.js.",
      "Implemented MongoDB for efficient data management and real-time participant interactions.",
  ...
  },
  {
    ...
    tags: [
      ...
      },
      {
        id: 2,
        name: "AI/ML",
        path: "/assets/logos/AIML.png",
      },
      {
        id: 3,
        name: "Voice API",
        path: "/assets/logos/va-square-5.svg",
      },
      {
        id: 4,
        name: "Node.js",
...
export const experiences = [
  {
    ...
    date: "June 2025",
    contents: [
      "Analyzed operations at a 1980 MW thermal power plant consisting of 4 × 110 MW subcritical units and 2 × 660 MW supercritical units.",
